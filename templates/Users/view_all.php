                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0 product">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody id="mytable">
                                <?php foreach ($countall['product'] as $product) : ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                        ...
                                        <td class="align-middle text-center">
                                              <h6 class="mb-0 text-sm"><?= h($product->category->category_name) ?></h6>
                                        </td>
                                        <td class="align-middle text-center">
                                              <h6 class="mb-0 text-sm"><?= h($product->short_discription) ?></h6>
                                        </td>
                                ...
                                ?>
                                    <tr id="data<?= $lead->id ?>">
                                        ...
                                        <td class="text-capitalize align-middle text-center">
                                            <h6 class="mb-0 text-sm"><?= h($lead->name) ?></h6>
                                        </td>

                                        <td class="align-middle text-center">
                                            <h6 class="mb-0 text-sm"><?= ($lead->price) ?></h6>
                                        </td>

                                        <td class="text-capitalize align-middle text-center">
                                            <h6 class="mb-0 text-sm"><?= h($lead->work_title) ?></h6>
                                        </td>
                                        <td class="align-middle text-center">
                                        ...
                                        <td class="align-middle text-center">
                                            <h6 class="mb-0 text-sm"><?= h($lead->lead_contact['contact']) ?></h6>
                                        </td>
                                        <td class="align-middle text-center">
                                            <h6 class="mb-0 text-sm"><?= h($lead->user->user_profile['first_name']) ?> <?= h($lead->user->user_profile['last_name']) ?></h6>
                                        </td>
                                        <td class="align-middle text-center">
                                            <h6 class="mb-0 text-sm"><?= h($lead->created_date) ?></h6>
                                        </td>
                                        <td class="align-middle text-center">
                                            <h6 class="mb-0 text-sm"><?php
