                            ...
                            <tbody>
                                <?php foreach ($companies as $company) : 
                                    ...
                                    <tr id="data<?= $company->id ?>">
                                        ...
                                        <td class="align-middle text-center">
                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#companyView" class="btn btn-success editCompany" data-id="<?= $company->id ?>">View</a>
                      ...
                      <div class="card-body p-4">
                        ...
                        <div class="row pt-1">
                          <div class="col-6 mb-3">
                            <h6>Company Name</h6>
                            <p class="text-muted"><?= h($company->company_name) ?></p>
                          </div>
