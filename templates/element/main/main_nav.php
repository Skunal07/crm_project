        ...
        <div class="collapse navbar-collapse topnav-right" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto float-end">
                <li class="nav-item active">
                    <a class="nav-link text-light nav-menu px-3 mx-3 " href="/users">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light nav-menu px-3 mx-3" href="/users/downloadPdf">Download Pdf</a>
                </li>
            </ul>
